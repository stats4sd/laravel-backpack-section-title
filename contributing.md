...
- code contributions are accepted via Pull Requests to [this Github repo](https://github.com/stats4sd/laravel-backpack-section-title);
- documentation contributions are accepted via Pull Requests to [this Github repo](https://github.com/stats4sd/laravel-backpack-section-title);
- other contributions are most likely welcome in the way you see fit;

# Things you could do
If you want to contribute but do not know where to start, this list provides some starting points.
- Test and confirm this works with Backpack 5 - if changes are needed, I would welcome a PR!
